              ...
              <div class="col-md-12">
                <?php 
                  ...
                  while($row2 = mysqli_fetch_array($run2)){
                    ...
                    echo
                    '<a href="project_single.php?project_id='.$project_id.'&project_floor='.$floor_id.'&flat_id='.$flat_id.'">
                      <div class="col-md-6 flat_main_wrp">
                        <div class="col-md-12 flat_wrp">
                          ...
                          <div class="col-md-4">
                            <div class="col-md-12">
                              ბინის ნომერი : '.$flat_name.'
                            </div>
                            <div class="col-md-12">
                              კვადრატულობა: '.$m2.'
                            </div>
                            <div class="col-md-12">
                              კვადრატულის ფასი: '.$kvm_price.'
                            </div>
                            <div class="col-md-12">
                              ბინის ფასი: '.$price.'
                            </div>
