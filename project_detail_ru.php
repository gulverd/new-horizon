              ...
              <div class="col-md-12">
                ...
                <div class="col-md-12 project_image_wrp">
                  ...
                  <?php
                    ...
                    $query      = "SELECT 
                    a.name_rus,a.about_rus,a.image,a.map,
                    ...
                    if(mysqli_num_rows($run) >=1){
                      ...
                      while($row    = mysqli_fetch_array($run)){
                        ...
                        $fl_id         = $row['floor_id'];
                        echo '<area imga="imgs/projects/'.$project_image.'" shape="poly" coords="'.$coordinates.'" href="project_floor_ru.php?project_id='.$project_id.'&floor_id='.$fl_id.'">';
                      }
                      echo '</map>';
                    }else{
