  <div class="content">
    <div class="col-md-12 titlesectionwrp" id="font">
          ...
          <a href="news_ru.php" class="link-arrow-2 pull-right">ПРОСМОТРЕТЬ ВСЕ НОВОСТИ <i class="icon ion-ios-arrow-right"></i></a>
          </h2>
    </div>  
                          ...
                          <div class="news-item">
                            ...
                            <div class="news-hover">
                              ...
                              <div class="content">
                                ...
                                <h3 class="news-title"><a class="read-more-title" href="news_inside_ru.php?news_id='.$id.'">'.$title.'</a></h3>
                              ...
                              <a class="read-more" href="news_inside_ru.php?news_id='.$id.'">ПРОСМОТР НОВОСТ</a>
                            </div>
                          </div>
                        </div>
                      ';
