              ...
              <div class="col-md-12">
                <?php 
                  ...
                  while($row2 = mysqli_fetch_array($run2)){
                    ...
                    echo
                    '<a href="project_single_ru.php?project_id='.$project_id.'&project_floor='.$floor_id.'&flat_id='.$flat_id.'">
                      <div class="col-md-6 flat_main_wrp">
                        <div class="col-md-12 flat_wrp">
                          ...
                          <div class="col-md-4">
                            <div class="col-md-12">
                              номер квартиры : '.$flat_name.'
                            </div>
                            <div class="col-md-12">
                              M2 : '.$m2.'
                            </div>
                            <div class="col-md-12">
                              M2 стоимость: '.$kvm_price.'
                            </div>
                            <div class="col-md-12">
                              стоимость квартиры: '.$price.'
                            </div>
                          </div>
                        </div>
                      </div>
