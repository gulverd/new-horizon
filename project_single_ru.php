...
<div class="animsition">
    ...
    <?php 
      ...
      while($row    = mysqli_fetch_array($run)){
        $project_name  = $row['name_rus'];
        $project_text  = $row['about_rus'];
        $project_map   = $row['map'];
      }
        ...
        <section class="section about-info">
          <div class="container">
              <div class="col-md-12 project_in_title_wrp">
                ...
                <span id="flat_name_span"> квартирa: <?php echo $flat_name;?></span></h1>
              </div>
                      ...
                      <div class="col-md-12">
                          ...
                          <div class="col-md-4">
                            <div class="col-md-12 flat_font_size">
                              номер квартиры : <strong><?php echo $flat_name;?></strong>
                            </div>
                            <div class="col-md-12 flat_font_size">
                              M2: <strong><?php echo $m2;?></strong>
                            </div>
                            <div class="col-md-12 flat_font_size">
                              M2 стоимость: <strong><?php echo $kvm_price;?></strong>
                            </div>
                            <div class="col-md-12 flat_font_size">
                              Cтоимость квартиры: <strong><?php echo $price;?></strong>
                            </div>
                          </div>
                        </div>
                </div>
