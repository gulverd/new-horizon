  <div class="content">
    <div class="col-md-12 titlesectionwrp" id="font">
          <h2 class="section-title">სიახლეები 
          <a href="news.php" class="link-arrow-2 pull-right">იხილეთ ყველა სიახლე <i class="icon ion-ios-arrow-right"></i></a>
          </h2>
    </div>  
                          ...
                          <div class="news-item">
                            ...
                            <div class="news-hover">
                              ...
                              <div class="content">
                                ...
                                <h3 class="news-title"><a class="read-more-title" href="news_inside.php?news_id='.$id.'">'.$title.'</a></h3>
                              ...
                              <a class="read-more" href="news_inside.php?news_id='.$id.'">ვრცლად</a>
                            </div>
                          </div>
                        </div>
                      ';
