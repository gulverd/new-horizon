                ...
                <div class="row-contact row">
                  <div class="col-contact col-lg-7 contact_mess_wrp">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6 col-lg-4">
                        <input class="input-gray" type="text" name="name" required placeholder="სახელი და გვარი">
                      </div>
                      <div class="form-group col-sm-6 col-lg-4">
                        <input class="input-gray" type="email" name="email" placeholder="Email">
                      </div>
                      <div class="form-group col-sm-12 col-lg-4">
                        <input class="input-gray" type="text" name="subject" placeholder="სათაური (არასავალდებულო)">
                      </div>
                      <div class="form-group col-sm-12">
                        <textarea class="input-gray" name="message"  required  placeholder="მესიჯი"></textarea>
                      </div>
                      <div class="col-sm-12">
                        <input type="submit" name="submit" class="btn-upper btn-yellow btn" value="გაგზავნა">
                      </div>
                    </div>
                  ...
                  <div class="col-contact col-lg-5">
                    ...
                    <div class="col-md-6 contact_working_wrp">
                      <p>სამუშაო საათები</p>
                      <p class="working_hours">ორშაბათი - პარასკევი :</br> 09:00 - 18:00</p>
                    </div>
...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    mail('office@new-horizon.ge', $subject,$message, $headers);
  }
