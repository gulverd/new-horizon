                ...
                <div class="row-contact row">
                  <div class="col-contact col-lg-7 contact_mess_wrp">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-sm-12 col-lg-4">
                        <input class="input-gray" type="text" name="subject" placeholder="SUBJECT (OPTIONAL)">
                      </div>
                      <div class="form-group col-sm-12">
                        <textarea class="input-gray" name="message"  required  placeholder="MESSAGE"></textarea>
                      </div>
                      <div class="col-sm-12">
                        <input type="submit" name="submit" class="btn-upper btn-yellow btn" value="SEND">
                      </div>
                    </div>
                  ...
                  <div class="col-contact col-lg-5">
                    ...
                    <div class="col-md-6 contact_working_wrp">
                      <p>WORKING HOURS</p>
                      <p class="working_hours">MONDAY - FRIDAY :</br> 09:00 - 18:00</p>
                    </div>
