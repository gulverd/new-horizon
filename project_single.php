...
<div class="animsition">
    ...
    <?php 
      ...
      $query      = "SELECT a.name_geo,a.about_geo,a.map
      FROM projects a
      WHERE a.id = '$project_id'";
      $run        = mysqli_query($conn,$query);

      while($row    = mysqli_fetch_array($run)){
        $project_name  = $row['name_geo'];
        $project_text  = $row['about_geo'];
        $project_map   = $row['map'];
      }
        ...
        <section class="section about-info">
          <div class="container">
              <div class="col-md-12 project_in_title_wrp">
                ...
                <span id="flat_name_span"> ბინა: <?php echo $flat_name;?></span></h1>
              </div>
                      ...
                      <div class="col-md-12">
                          ...
                          <div class="col-md-4">
                            <div class="col-md-12 flat_font_size">
                              ბინის ნომერი : <strong><?php echo $flat_name;?></strong>
                            </div>
                            <div class="col-md-12 flat_font_size">
                              კვადრატულობა: <strong><?php echo $m2;?></strong>
                            </div>
                            <div class="col-md-12 flat_font_size">
                              კვადრატულის ფასი: <strong><?php echo $kvm_price;?></strong>
                            </div>
                            <div class="col-md-12 flat_font_size">
                              ბინის ფასი: <strong><?php echo $price;?></strong>
                            </div>
                          </div>
                        </div>
                </div>
                ...
                <div class="col-md-12">
                  <h4>პროექტის ადგილმდებარეობა</h4>
                </div>
                <div class="col-md-12">
